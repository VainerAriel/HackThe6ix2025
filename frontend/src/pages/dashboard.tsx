...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-[#fafbfc] flex flex-col">
            ...
            {/* Main Content */}
            <div className="flex-1 flex flex-col items-center justify-center px-6 -mt-20 pointer-events-none">
                <div className="text-center max-w-md">
                    ...
                    <button
                        ...
                        className="inline-block px-8 py-4 bg-gradient-to-r from-[#8b5cf6] to-[#a855f7] text-white font-medium rounded-lg hover:from-[#7c3aed] hover:to-[#9333ea] transition-all duration-200 transform hover:scale-105 shadow-lg pointer-events-auto"
                    >
                        Start Questionnaire
                    </button>
                </div>
